...
\begin{itemize}
  ...
  \item Within two weeks I plan to test if guidance works with chat versions of LLaMA 2 based on some feedback on the github issue I created\footref{issue}. If it works then I plan to submit a pull request. 
\end{itemize}
